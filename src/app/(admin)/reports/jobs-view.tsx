/**
 * The CRM's "Aufträge & Baustellen" tab: the sites behind the Heute tiles.
 *
 * The sites — late, running, starting soon — as one card each, every job once,
 * in groups or as a kanban with a column for each group. The list of jobs by
 * stage and the missing material stood here too; the Heute sheets carry them.
 *
 * Everything here is "Stand heute": it does not follow the year and period
 * pickers. Old data — work finished before the history cutoff — never shows.
 */
