...
*Version 1.15 · Stand: 23. August 2026*
...
- **Fett** = so heißt es auf dem Bildschirm (Knopf, Menüpunkt, Feld).
- Nummerierte Schritte = in dieser Reihenfolge klicken.
- 💡 = Tipp, der Zeit spart. ⚠ = Vorsicht, hier kann etwas schiefgehen.
- „Klicken“ gilt am Computer; am Handy oder Tablet heißt es „Tippen“.
...
7. [Einsatzplanung (der Wochenplan)](#7-einsatzplanung-der-wochenplan)
8. [Arbeitsauftrag drucken](#8-arbeitsauftrag-drucken)
9. [Lager: Werkzeug, Material und Tagesvorbereitung](#9-lager-werkzeug-material-und-tagesvorbereitung)
10. [Mitarbeiter, Fähigkeiten und Benutzerkonten](#10-mitarbeiter-fähigkeiten-und-benutzerkonten)
...
18. [Für den Administrator: Installation und Sicherung](#18-für-den-administrator-installation-und-sicherung)

---

## 1. Was ist BauCrew?

BauCrew ist das digitale Büro für Ihre Baustellen. Es ersetzt den Wochenplan an der Wand, die Excel-Liste mit den Aufträgen, die Zettel im Lager und die ausgedruckten Arbeitsaufträge — und zwar mit einer einzigen Regel:
...
BauCrew läuft im **Browser** (Chrome, Edge, Safari, Firefox) — am Computer, am Tablet und am Handy. Nichts muss installiert werden.

---

## 2. Der erste Tag: Anmelden und zurechtfinden

### 2.1 Anmelden

![Anmeldung](screenshots/01-login.png)

1. Öffnen Sie im Browser die Adresse, die Sie von Ihrer Firma bekommen haben (z. B. `https://baucrew.ihre-firma.de`).
...
|---|---|---|
| `admin` | Administrator | die Geschäftsführung |
| `buero` | Büro / Verwaltung | das Büro |
| `lager` | Mitarbeiter | den Bildschirm im Lager (gemeinsames Konto) |

Konten für einzelne Mitarbeiter legen Sie auf der jeweiligen Mitarbeiterseite an (Kapitel 10.3).

---

## 4. Schnellstart: In 10 Minuten vom Auftrag zum Wochenplan

So läuft ein typischer neuer Auftrag — einmal komplett durch. Alles Weitere in den Kapiteln danach.

**Schritt 1 — Kunde anlegen (falls neu)**
Menü **Kunden** → **Neuer Kunde** → Name, Telefon, Straße, PLZ, **Ort** eintippen und den Ort **aus der Vorschlagsliste** anklicken (wichtig für die Wetterwarnung) → **Speichern**.

**Schritt 2 — Projekt anlegen**
Menü **Projekte** → **Neues Projekt** → Projektname (z. B. „Fassade Musterstraße 12“) → Feld **Kunde**: Namen tippen, Kunden anklicken. Die Adresse des Kunden wird automatisch als Baustellenadresse übernommen (Haken **Wie Kundenadresse**). Ist die Baustelle woanders: Haken entfernen und Adresse eintippen. **Bezeichnung der Arbeit** ankreuzen (z. B. Außenfassade), Termine und Auftragswert eintragen, **Mitarbeiter** und **Fahrzeug** anhaken → **Speichern**.

**Schritt 3 — Werkzeug und Material prüfen**
...
Hier stehen alle Auftraggeber: Privatpersonen, Firmen, Hausverwaltungen. Die Liste durchsuchen Sie mit dem Suchfeld (Name, Firma, Telefon, E-Mail). Ein Klick auf einen Namen öffnet die Kundenseite mit allen Projekten dieses Kunden.

### 5.1 Neuen Kunden anlegen

![Kunde anlegen — Ort wählen](screenshots/25-kunde-neu-ort.png)

1. **Neuer Kunde** oben rechts.
2. **Name** ist Pflicht. **Kundennummer** (die Nummer aus Ihrer Angebotssoftware), Firma, Ansprechpartner, Telefon, E-Mail nach Bedarf. Die Kundennummer wird in der Kundensuche mitgefunden und steht auf der Board-Karte.
...
💡 Sie können Kunden auch **mitten im Projektformular** anlegen: Im Feld **Kunde** den neuen Namen tippen → „… als neuen Kunden anlegen“ wählen → kleines Fenster ausfüllen → fertig, der Kunde ist ausgewählt.

### 5.2 Kunden bearbeiten oder löschen

Kundenseite → **Bearbeiten**. Löschen geht nur, solange der Kunde keine Projekte hat — Sie sollen keine Historie verlieren.

---

## 6. Projekte

**Wo:** Menü → **Projekte**. Das Projekt ist das Herz von BauCrew — alles andere hängt daran.

### 6.1 Die Projektliste
...
Mit **Liste / Board** rechts oben wechseln Sie zur Board-Ansicht — Suche, Jahr, **Filter** und der Status-Reiter gehen dabei mit: Wer in der Liste auf *In Ausführung* steht und zum Board wechselt, sieht dort nur diese Spalte (ein kleines Schild **Nur: In Ausführung ✕** nimmt die Einschränkung wieder weg). Das Board: eine Spalte je Status, und eine Karte in eine andere Spalte ziehen ändert den Status (Abschließen und Stornieren fragen vorher nach; jede Bewegung lässt sich mit **Rückgängig** unter dem Board zurücknehmen). Über der Suche stehen die **Boards** als Reiter, wie in Trello: zum Beispiel *Vertrieb* mit *Anfrage → Angebot → Beauftragt* und *Baustellen* mit *Beauftragt → Geplant → In Ausführung → Abgeschlossen*. Ein Projekt steht auf jedem Board, das eine Spalte für seinen Status hat — ein Board ist eine Sicht auf die Projekte, kein zweiter Ort. Welches Board zuletzt offen war, merkt sich der Browser.

Das Board sieht aus und bewegt sich wie in Trello. Es füllt die Seite bis an den Rand, auf einem **Hintergrund**, den jedes Board für sich wählt (Einstellungen → Boards: acht Farben, vier Verläufe oder ohne; neue Boards beginnen mit Trello-Blau). Oben quer die **Leiste** des Boards: links die Boards als helle Reiter, rechts die Suche, der **Filter**, das Jahr, **Liste / Board**, **Neues Projekt** und das **Board-Menü (…)** — dort stehen *Kartendetails anzeigen*, *Archivierte Karten*, die Entwürfe, Vorlagen, Checklisten und Formulare sowie *Boards verwalten*. Darunter die grauen **Listen**, so hoch wie ihre Karten. Am Fuß jeder Liste steht **Karte hinzufügen**: Name, Kunde (suchen oder neu eintippen), auf Wunsch eine **Vorlage**, Enter — das Projekt entsteht im Status dieser Liste, mit allem, was die Vorlage mitbringt (Beschreibung, Gewerk, Bauleitung und Team, Fahrzeuge, Geräte, Werkzeug und Material, Checklisten). Das Feld bleibt für die nächste Karte offen, die gewählte Vorlage auch.

**Karten ziehen** — wie in Trello: Eine Karte anfassen und ziehen; ein grauer Platzhalter zeigt, wo sie landet, und wandert vor dem Mauszeiger her. In eine andere Liste gezogen ändert sie ihren Status (Abschließen und Stornieren fragen vorher nach), innerhalb der Liste nach oben oder unten gezogen behält sie **ihren Platz** — die Reihenfolge ist Ihre, nicht die der Nummern, und bleibt für alle so. Escape legt die Karte zurück, jede Bewegung lässt sich mit **Rückgängig** unter dem Board zurücknehmen. Am Tablet hält man die Karte kurz fest, bevor man sie zieht. Der **Stift** oben rechts auf einer Karte (erscheint beim Überfahren, am Tablet immer) öffnet das Schnellmenü: Karte öffnen, umbenennen, **Karte kopieren** (eine neue Karte mit demselben Kunden, derselben Adresse, denselben Gewerken, Leuten, Fahrzeugen, Material, Geräten und Checklisten — direkt unter dem Original, mit neuer Nummer und ohne Termine, Preise, Dateien und Kommentare; sie öffnet sich gleich zum Anpassen), dringend an/aus, in eine andere Liste verschieben. Beim Ziehen gleiten die anderen Karten beiseite, wie in Trello.

**Listen** — wie in Trello: Der Kopf einer Liste ist ihr Griff (anfassen und ziehen ordnet die Listen; der Hintergrund dazwischen schiebt das Board). Ein Klick auf den Namen tippt ihn um — so heißt die Liste auf diesem Board, wie sie in Trello hieß. Das **Listenmenü (…)** bietet *Karte hinzufügen*, *Liste einklappen* (zu einem schmalen Streifen, den ein Klick wieder öffnet; der Browser merkt es sich), *Liste umbenennen*, **Liste sortieren nach** (Name, Nummer, geplanter Beginn, Erstellt — die Reihenfolge wird geschrieben und gilt für alle) und *Liste vom Board nehmen* (die letzte bleibt; ihre Projekte bleiben auf jedem Board, das ihren Status zeigt). Ganz rechts steht **+ Weitere Liste** für einen Status, den das Board noch nicht zeigt — und für die **Regel-Listen**, die Trello-Boards oft haben: **Pause** (laufende Baustellen, die gerade ruhen), **Nächstes Jahr** (Aufträge, deren geplanter Beginn in einem späteren Jahr liegt), **Warteliste** (Aufträge mit niedriger Priorität) und **Abschlag gestellt** (laufende Baustellen, deren Rechnung 1 als bereit gemeldet ist). Eine Regel-Liste (im Kopf mit *Regel* markiert) zeigt von ihrem Status nur die Karten, auf die die Regel zutrifft; die gewöhnliche Liste desselben Status zeigt die übrigen. Eine Karte in die Pause ziehen legt sie still, aus der Pause ziehen weckt sie; in die Warteliste ziehen setzt die Priorität auf niedrig, heraus ziehen nimmt sie zurück; in *Nächstes Jahr* ziehen setzt den geplanten Beginn auf den 1. Januar des nächsten Jahres, wenn noch kein späterer Termin steht. In *Abschlag gestellt* kommt eine Karte von selbst, sobald Rechnung 1 am Projekt gemeldet ist — ziehen geht dort nicht. Umbenennen, sortieren, hinzufügen und wegnehmen sind Sache des Büros; die Bauleitung (Rolle) zieht Karten.

Jede **Karte** zeigt, was eine Trello-Karte zeigt: oben die Etiketten (*Hoch* bei Priorität, *SUB*, die Gewerke in je einer Farbe — ein Klick auf ein Etikett klappt alle zu schmalen Farbbalken zusammen und wieder auf; welche Farbe ein Gewerk trägt, legen Sie unter **Einstellungen → Arbeitsbereiche → Arbeitskategorien** fest), darüber das **Titelbild**, wenn eines gewählt ist, dann der Name und eine Reihe kleiner Zeichen: ≡ für eine Beschreibung, **Beginn – Ende** (rot, wenn das geplante Ende überschritten ist; gelb, wenn ein noch nicht begonnenes Projekt in den nächsten sieben Tagen beginnt), **Fällig am** mit einer Uhr, der Stand der Checklisten (3/8, ⚠ bei einem Problem), offene Aufgaben und Mängel, Dateien und Kommentare; rechts unten die Köpfe — die Bauleitung mit farbigem Ring, dann das Team. Mehr zeigt die Karte erst mit **Kartendetails anzeigen** im Board-Menü: Kunde mit Kundennummer, Baustellenadresse, Projektnummer und Anlagedatum, mit Finanzfreigabe der Auftragswert, und über jeder Liste ihre Summe. Die Wahl merkt sich der Browser; die Karte, die der Kunde aus Trello kennt, ist die Voreinstellung.

Ein **Klick auf eine Karte** öffnet die **Kartenrückseite** über dem Board, aufgebaut wie in Trello: oben das Titelbild, dann Titel und Status, **Mitglieder**, **Etiketten**, **Termine**, **Fällig am** und der Auftragswert auf einen Blick, darunter die Reihe **Zur Karte hinzufügen** (Mitglieder, Etiketten, Checkliste, Termine, Anhang, Kommentar) — jeder Knopf öffnet das passende Feld oder springt zur Liste. Dann, untereinander: die **Beschreibung** (Stift zum Bearbeiten), eine Zeile **Projektdaten** (Grunddaten, Adresse, Termine und Preis, Zuordnung — ein Klick klappt die vier Karten auf; Bearbeiten und die Knöpfe oben öffnen sie von selbst), die **Dateien** mit den Fotos als Kacheln, **Checklisten**, **Aufgaben**, **Mängel**, **Formulare**, die **geplanten Einsätze** und zuletzt eine Zeile **Weitere Angaben** (Material, Geräte, erfasste Zeit, Nachträge, Rechnungen), die ebenfalls ein Klick öffnet. Rechts, wie in Trello, stehen die **Kommentare** als eigene Spalte neben den Karten, und darunter der **Verlauf**: wer die Karte wann von wo nach wo verschoben, archiviert, umbenannt hat, wer ein Foto angehängt, eine Aufgabe erledigt, einen Mangel gemeldet, ein Formular unterschreiben lassen hat. Die volle Projektseite (**Projektseite öffnen**) zeigt dieselben Karten wie bisher nebeneinander. **Projektseite öffnen** führt zur ganzen Seite; geschlossen wird mit dem **Kreuz** ganz rechts in der Leiste oder mit Escape — ein Klick neben die Karte schließt sie absichtlich nicht, damit nichts Getipptes verloren geht. Die Adresse mit `?card=…` lässt sich als Link weitergeben. **Zusammenführen** (ein doppelt angelegtes Projekt in dieses übernehmen, nur Administrator) steht neben Speichern und Abbrechen, sobald **Bearbeiten** gedrückt ist. Der Knopf **Filter** neben der Suche engt Board und Liste ein: ein Mitarbeiter (als Bauleitung oder im Team), ein Gewerk, nur dringende, und — wie in Trello — **Fällig**: *Überfällig*, *in der nächsten Woche*, *im nächsten Monat* (nach dem Feld *Fällig am*) oder *Ohne Termin* (weder geplanter Beginn noch Fälligkeit). Im Feld oben tippen, die Listen suchen mit, Enter nimmt den ersten Treffer; die Wahl bleibt beim Wechsel zwischen den Boards erhalten.

**Archivieren** — wie in Trello: **Archivieren** in der Leiste des Projekts legt die Karte weg: Sie verschwindet vom Board, aus der Liste, von der Seite Baustellen und aus der Pipeline, bleibt aber ein Projekt — in der Einsatzplanung, im CRM, auf ihrer eigenen Seite, die es oben in einem gelben Balken sagt. Nichts wird gelöscht. **Archivierte Karten** im Board-Menü öffnet den Archivbereich rechts über dem Board — mit Suchfeld (Nummer, Name, Kunde, während des Tippens); **Wiederherstellen** holt eine Karte zurück auf das Board, **Löschen** (nur Administrator, mit Rückfrage) entfernt sie endgültig. Ein **Titelbild** bekommt eine Karte in der Dateikarte des Projekts: unter jedem Foto steht *Titelbild*; ein zweiter Klick nimmt es wieder weg.

Boards anlegen, umbenennen, Spalten wählen und löschen: **Einstellungen → Boards** (Administrator). Jede Spalte ist ein Status und kann auf dem Board einen **eigenen Namen** tragen. Das letzte Board lässt sich nicht löschen. Ganz oben auf der Seite steht **Board wie in Trello anlegen**: ein Klick, und das Board „Aktuell laufende Baustellen“ steht da, Liste für Liste wie in Trello — *Aufträge*, *Aufträge für nächstes Jahr*, *Warteliste Kleinaufträge*, *Baustellenbeginn*, *Baustelle läuft*, *Baustellenunterbrechung / Pause*, *Abschlagszahlungen*, *Fertigstellung*, *Rechnungsstellung*, *Erledigt* — drei davon Regel-Listen. Die Namen lassen sich danach auf dem Board ändern.

### 6.2 Ein Projekt anlegen — Feld für Feld

![Projekt anlegen](screenshots/04-projekt-neu.png)

**Neues Projekt** oben rechts. Das Formular hat mehrere Kästen:

**Aus Vorlage erstellen** (ganz oben, optional): Haben Sie eine Vorlage (z. B. „Außenfassade streichen“), wählen Sie sie hier — Name, Kategorie und die Werkzeugliste werden vorbelegt.

**Grunddaten**
- **Projektname** (Pflicht) — z. B. „Muster Beispielplatz 10“.
...
- Sobald Sie einen Kunden **mit Adresse** gewählt haben und die Adressfelder noch leer sind, setzt BauCrew den Haken **Wie Kundenadresse** und übernimmt Straße, PLZ, Ort und Telefon (die Felder sind dann grau). Nur **Ansprechpartner vor Ort** bleibt zum Ausfüllen.
- Ist die Baustelle **woanders** (z. B. Hausverwaltung mit vielen Objekten): Haken entfernen → die Felder werden leer und Sie tippen die Baustellenadresse ein. Haken wieder setzen holt die Kundenadresse zurück.
- Hat der Kunde keine Adresse, ist der Haken gesperrt („Der Kunde hat keine Adresse hinterlegt“).
...
**Termine und Preis**
- **Fällig am** — der Tag, bis zu dem die Arbeit fertig sein muss: die Zusage an den Kunden, unabhängig von der eigenen Planung. Auf der Karte gelb in der letzten Woche, rot danach.
...
- **Ausführung voraussichtlich (Monat)** und **Dauer (Monate)** — wo der Auftrag im Planumsatz steht, solange kein Beginn feststeht: der Monat, in dem die Arbeit voraussichtlich läuft, und über wie viele Monate; der Auftragswert verteilt sich gleichmäßig darauf. Steht ein Beginn fest, gilt sein Monat — und mit einem Ende die Monate dazwischen. Im Planumsatz (Kapitel 14) lässt sich der Auftrag auch in einen anderen Monat ziehen; ein fester Beginn wandert dabei um ganze Monate mit.
...
- **Rechnungen** — abgerechnet wird in zwei Hälften: **Abschlagsrechnung (50 %)** und **Schlussrechnung**. Die Rechnung selbst schreiben Sie in der Buchhaltung; ist sie fertig, auf der Projektseite **Als bereit melden** (Rechnungsnummer optional, Betrag vorgeschlagen: die Hälfte des Auftragswerts, bei der Schlussrechnung der Rest — Nachträge landen also dort). Eine eingerichtete Automation (Einstellungen → Webhooks, Ereignis *Rechnung bereit*) bereitet daraufhin die E-Mail vor. **Zurücknehmen** nimmt die Meldung zurück; eine schon vorbereitete E-Mail bleibt bestehen. Nur mit Finanzfreigabe.
...
- **Beschreibung** erscheint auf dem Arbeitsauftrag (Hinweise fürs Team).
- **Interne Notizen** sieht nur die Verwaltung — nie das Team, nie auf dem Arbeitsauftrag.

Zum Schluss **Speichern** → die Projektseite öffnet sich.

### 6.3 Die Projektseite
...
Projekt zu verlassen. Oben rechts in der Vorschau: in neuem Tab öffnen,
herunterladen, schließen (auch mit Escape oder einem Klick daneben). Excel- und
Word-Dateien öffnen wie bisher in einem neuen Tab.
...
- **Wetter:** Regenwarnung für Einsätze mit Außenarbeit und erkanntem Ort.
- Druckersymbol auf der Karte → Arbeitsauftrag.

### 7.2 Das Einsatzfenster
...
💡 Oben rechts ist ein **QR-Code**. Mit der Handy-Kamera scannen → derselbe Arbeitsauftrag öffnet sich am Handy (nach Anmeldung).

---

## 9. Lager: Werkzeug, Material und Tagesvorbereitung
...
Der Katalog ist die Liste aller Werkzeuge (Leiter, Gerüst, Spritzgerät …) und Materialien (Farbe, Grundierung, Folie …). Aus ihm werden die Projektlisten bestückt.
...
Nicht mehr benötigte Artikel setzen Sie auf **inaktiv** — sie bleiben in alten Projekten sichtbar, sind aber nicht mehr auswählbar. Löschen geht nur, wenn kein Projekt und keine Vorlage sie benutzt.

### 9.2 Tagesvorbereitung — der Bildschirm im Lager

![Tagesvorbereitung](screenshots/15-tagesvorbereitung.png)

**Wo:** Menü → **Lager** → **Tagesvorbereitung** (oder direkt `/today`). Gedacht für einen Bildschirm oder ein Tablet im Lager, angemeldet mit dem gemeinsamen Konto `lager`.

- Zeigt alle **Einsätze von heute** (Datum umschaltbar) mit Team, Fahrzeugen und **Packliste**.
- Pro Artikel zwei große Knöpfe: **Gepackt ✓** oder **Fehlt ⚠**. Der Fortschritt („3 von 5“) ist sofort auf der Übersicht und am Handy der Mitarbeiter sichtbar.
- Die Seite aktualisiert sich von selbst. Je Einsatz kann der **Arbeitsauftrag** gedruckt werden.
...
Die Liste zeigt Name, Telefon, Fähigkeiten, Status und in der Spalte **Konto**, wer sich anmelden kann. Die Suche findet auch Teile einer Fähigkeit („fass“ → Fassade).

### 10.1 Mitarbeiter anlegen

1. **Neuer Mitarbeiter** → **Vorname**, **Nachname** (Pflicht), Telefon, E-Mail.
...
Kontaktdaten, **kommende Einsätze**, alle Projekte und der Kasten **Benutzerkonto**. Mitarbeiter mit Projekten oder Einsätzen können nicht gelöscht werden — setzen Sie sie auf **inaktiv**, die Historie bleibt.

### 10.3 Benutzerkonto — damit der Mitarbeiter das Handy nutzen kann (nur Administrator)

![Benutzerkonto](screenshots/21-mitarbeiter-konto.png)

**Konto anlegen**
1. Mitarbeiterseite → Kasten **Benutzerkonto** → Haken **Benutzerkonto aktivieren**.
2. **Benutzername** (nur Kleinbuchstaben, Zahlen, Punkt, Minus, Unterstrich — z. B. `max.muster`), **Passwort** (mindestens 8 Zeichen), **Rolle** (normalerweise *Mitarbeiter*).
3. **Konto anlegen**. Teilen Sie dem Mitarbeiter Benutzername und Passwort mit — er meldet sich am Handy an und sieht „Mein Bereich“.

**Konto ändern**
Im selben Kasten: **Rolle**, **Neues Passwort** (leer lassen = unverändert; ein neues Passwort meldet ihn auf allen anderen Geräten ab), **Finanzdaten sichtbar**, **Aktiv**. Dann **Speichern** → „✓ Gespeichert“.
...
Name (z. B. „Sprinter weiß“), Kennzeichen, Typ, Notizen und **Status**: *Verfügbar · Im Einsatz · Werkstatt · Außer Betrieb*. Auf der Fahrzeugseite schalten Sie den Status direkt um und sehen die kommenden Einsätze.

Ist ein Fahrzeug nicht *Verfügbar*, aber eingeplant, erscheint ein Konflikt-Hinweis im Wochenplan. Fahrzeuge mit Einsätzen können nicht gelöscht werden — **Außer Betrieb** setzen.
...
**Benötigte Geräte — wie die Werkzeugliste:** Auf der **Projektseite** und im
**Einsatzfenster** steht die Karte *Benötigte Geräte* mit demselben Aufbau wie
Werkzeug und Material: unten ein Auswahlfeld zum Hinzufügen, pro Zeile ein ✕ zum
Entfernen. Jede Zeile zeigt mit grünem oder rotem Punkt, wo das Gerät gerade
ist — *im Lager*, *ist hier*, oder der Name der anderen Baustelle. Ist es frei,
steht daneben **Jetzt ausgeben** (ein Klick, und es ist auf diese Baustelle
gebucht); steht es hier, steht dort **Zurücknehmen**. Darunter listet die Karte,
was tatsächlich auf der Baustelle steht.

In der **Vorlage** hat *Benötigte Geräte* eine eigene Karte — die
...
## 13. Mein Bereich — für Mitarbeiter am Handy

*Diesen Abschnitt können Sie Ihren Mitarbeitern geben.*

![Mein Bereich](screenshots/20-mein-bereich-mobil.png)

1. Am Handy die BauCrew-Adresse öffnen, mit Benutzername und Passwort anmelden.
2. Sie sehen **Heute**: Ihre Einsätze mit Uhrzeit, Projekt, Kunde und Adresse.
   - **In Karten öffnen** → Navigation startet.
   - **Anrufen** → ruft die Baustelle / den Kunden an.
   - **Werkzeug und Material** → was mitgenommen wird und ob das Lager es schon gepackt hat.
   - **Arbeitsauftrag** → das Blatt zum Nachlesen.
3. Mit **Gestern / Morgen** blättern; darunter **Kommende Einsätze** und **Nächster Einsatz**.

Sie sehen nur Ihre eigenen Einsätze — und nie Preise. Ändern kann hier niemand etwas; die Planung macht das Büro.
...
- **Übersicht:** Umsatz des Zeitraums mit **Vergleich zum Vorjahr** (gleicher Zeitraum), SUB-Anteil, **Offener Auftragsbestand** in vier Stufen (*Angebote offen* · *Beauftragt (sicher)* · *In Ausführung* · *Geplant / offen*), das **Monatsdiagramm** (blau = dieses Jahr, dunkel eigene Leute / hell SUB; grau = Vorjahr) und daneben die Karte **Umsatz je Quartal**: Q1 bis Q4 als Ring, in der Mitte das **beste Quartal** mit seinem Anteil am Jahr. Darunter steht jedes Quartal mit seiner Summe, seinem Anteil und der Veränderung gegenüber demselben Quartal der Vergleichsjahre — voreingestellt das Vorjahr, über **Vergleichsjahre** rechts oben in der Karte sind bis zu zwei andere Jahre wählbar. Die Listen der Vergleichsjahre — hier und über dem Monatsdiagramm — bieten nur Jahre an, **in denen Zahlen stehen**: ein leeres Jahr brächte nur einen leeren Balken je Monat. Ein Jahr, das schon angehakt ist, bleibt in der Liste, damit es sich abwählen lässt. Ein Klick auf eine Quartalszeile setzt dieses Quartal als Zeitraum für die ganze Seite, ein zweiter nimmt ihn zurück. Ist eine **Jahresplanung** eingelesen, liegt im Monatsdiagramm über jedem Monat zusätzlich eine **gestrichelte Linie** auf Höhe des Planumsatzes. Ein **Klick auf einen Monat** im Diagramm — oder auf einen einzelnen Balken, wenn mehrere Jahre verglichen werden — klappt **direkt unter dem Diagramm** die Aufträge dieses Monats auf — **für jedes Jahr im Diagramm eine Spalte**, in der Reihenfolge und den Farben der Balken: Monatssumme, Zahl der Aufträge, wie weit das gewählte Jahr darüber oder darunter liegt (*2026 liegt 16 % darüber*), dann die Aufträge, eigene Leute und SUB getrennt, **der größte zuerst**; jede Zeile führt zum Projekt. Eine Spalte zeigt die ersten sechs, **+ n weitere** klappt den Rest auf. Wurde ein einzelner Balken angeklickt, ist die Spalte dieses Jahres markiert. Der Monat bleibt im Diagramm eingerahmt, ein Klick auf einen anderen Monat wechselt die Listen, ein zweiter Klick auf dieselbe Stelle (oder das ✕) schließt sie. Reiter, Jahr und Vergleichsjahre bleiben dabei, wie sie sind; **Im Planumsatz öffnen** oben rechts in der Liste führt zur vollen Monatsansicht.
- **Umsatz:** die Monatskarten mit allen Projekten und Beträgen (eigene Leute und SUB getrennt).
  Jeder Auftrag steht in dem Monat, in dem er läuft: mit festem **Beginn** in dessen Monat, sonst im
  ...
  **Jahresplanung** eingelesen (Kapitel 15), stehen ihre Zeilen, zu denen es noch kein Projekt gibt,
  ...
  einem Projekt zugeordnet wird, geht in ihm auf, und von da an zählt das Projekt. Das kleine ⓘ neben
  *Eigene Leute* und *SUB* erklärt die Zahl; die Zeile *Plan* darunter stellt die Summe der Tabelle
  daneben. Für ein Jahr, aus dem in BauCrew gar keine Projekte erfasst sind, sagt der Hinweis über den
  Monaten, dass die Zahlen ein **Rückblick** aus der Tabelle sind. Der Jahresvergleich oben rechts und
...
- **Planabgleich** (unter *Umsatz*, wenn eine Jahresplanung eingelesen ist): Die Karte
  ...
  **Baustelle** des Jahres eine Zeile — läuft sie in der Tabelle über mehrere Monate, sind
  ...
  sofern es sie noch nicht hat (Eingetragenes wird nie überschrieben); im Planumsatz zählt von da an
  das Projekt selbst, die Zeile nicht mehr.
...
**Excel-Export:** vier Blätter (Monatsplanumsatz, Auslastung, Plan vs Ist, Kunden) für den gewählten Zeitraum.

---

## 15. Einstellungen (nur Administrator)

**Wo:** Menü → **Einstellungen**.

![Einstellungen](screenshots/18-einstellungen.png)

**Systemkonten (ohne Mitarbeiter)** — `admin`, `buero`, `lager`: anlegen, bearbeiten (Benutzername, Passwort, Rolle, **Finanzdaten sichtbar**, aktiv), **Konto löschen**. Konten von Mitarbeitern werden auf der Mitarbeiterseite verwaltet (Kapitel 10.3).

**Passwort ändern:** Konto öffnen → neues Passwort eintragen → Speichern. Der Benutzer wird auf allen anderen Geräten abgemeldet.

**Zwei Schutzregeln beim Löschen:**
- Das Konto, mit dem Sie **gerade angemeldet** sind, können Sie nicht löschen — abmelden, mit einem anderen Administrator anmelden, dann löschen.
- Das **letzte aktive Administrator-Konto** kann nie gelöscht werden.

💡 So ersetzen Sie `admin` durch ein Konto mit Ihrem Namen: neues Konto mit Rolle Administrator anlegen → abmelden → mit dem neuen Konto anmelden → `admin` löschen.
...
Benutzername und Passwort prüfen (Groß-/Kleinschreibung!). Nach mehreren Fehlversuchen einige Minuten warten. Passwort vergessen → der Administrator setzt ein neues (Mitarbeiterseite oder Einstellungen).

**… ich keine Preise sehe?**
...
**… ich einen Mitarbeiter, ein Fahrzeug oder einen Kunden nicht löschen kann?**
Weil noch Projekte oder Einsätze daran hängen. Auf **inaktiv** / **Außer Betrieb** setzen — die Historie bleibt.

**… zwei Einsätze desselben Teams an einem Tag als Konflikt gemeldet werden?**
Beiden Einsätzen **Beginn und Ende** geben. Überschneiden sich die Zeiten nicht, verschwindet die Warnung.

**… ich mein eigenes Konto nicht löschen oder herabstufen kann?**
...
## 17. Kleines Wörterbuch

| Begriff | Bedeutung |
|---|---|
| **Projekt** | ein Auftrag / eine Baustelle — der zentrale Datensatz |
| **Einsatz** | ein Tag (oder Teil davon), an dem ein Team an einem Projekt arbeitet; erscheint als Karte im Wochenplan |
| **Arbeitsauftrag** | das A4-Blatt zum Projekt für Fahrzeug und Baustelle |
| **Packliste / Werkzeug und Material** | die Liste der Artikel, die für ein Projekt gebraucht werden; das Lager hakt sie ab |
...
## 18. Für den Administrator: Installation und Sicherung

BauCrew läuft mit Docker (App + Datenbank) auf Ihrem eigenen Server oder VPS — oder alternativ bei Vercel mit einer gehosteten Datenbank. Details und Befehle stehen in `README.md` und `DEPLOYMENT.md`; hier nur das Wichtigste:
