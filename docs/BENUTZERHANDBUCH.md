...
Das Board sieht aus wie in Trello: graue **Listen**, so hoch wie ihre Karten, auf einem **Hintergrund**, den jedes Board für sich wählt (Einstellungen → Boards: acht Farben, vier Verläufe oder ohne). Am Fuß jeder Liste steht **Karte hinzufügen**: Name, Kunde (suchen oder neu eintippen), auf Wunsch eine **Vorlage**, Enter — das Projekt entsteht im Status dieser Liste, mit allem, was die Vorlage mitbringt (Beschreibung, Gewerk, Bauleitung und Team, Fahrzeuge, Geräte, Werkzeug und Material, Checklisten). Das Feld bleibt für die nächste Karte offen, die gewählte Vorlage auch. Der **Stift** oben rechts auf einer Karte (erscheint beim Überfahren, am Tablet immer) öffnet das Schnellmenü: Karte öffnen, umbenennen, dringend an/aus, in eine andere Liste verschieben.

Jede **Karte** trägt, was ein Blick braucht: oben die Etiketten mit Namen (*Hoch* bei Priorität, *SUB*, die Gewerke in je einer Farbe) — ein Klick auf ein Etikett klappt alle zu schmalen Farbbalken zusammen, wie in Trello, und wieder auf; der Browser merkt es sich. Welche Farbe ein Gewerk trägt, legen Sie unter **Einstellungen → Arbeitsbereiche → Arbeitskategorien** fest (zehn Farben; die bestehenden Gewerke haben je eine eigene bekommen, ein neues nimmt mit *A* die am wenigsten vergebene), dann Name, Kunde mit **Kundennummer**, die **Baustellenadresse** in einer Zeile, darunter **Beginn – Ende** (rot, wenn das geplante Ende überschritten ist; gelb, wenn ein noch nicht begonnenes Projekt in den nächsten sieben Tagen beginnt), **Fällig am** mit einer Uhr (gelb in der letzten Woche, rot, sobald der Tag vorbei ist), der Stand der Checklisten (z. B. 3/8, ⚠ bei einem Problem), die Zahl der Dateien und Notizen und — mit Finanzfreigabe — der Auftragswert samt Nachträgen. Unten links stehen Projektnummer und **Anlagedatum**, unten rechts die Köpfe: die Bauleitung mit farbigem Ring, dann das Team. Über jeder Spalte stehen Anzahl und Summe. Ein **Klick auf eine Karte** öffnet das Projekt über dem Board — mit allen Karten der Projektseite, zum Lesen und Bearbeiten; Unter dem Titel stehen **Mitglieder**, **Etiketten**, **Termine**, **Fällig am** und der Auftragswert auf einen Blick, darunter die Reihe **Zur Karte hinzufügen** (Mitglieder, Etiketten, Checkliste, Termine, Anhang, Kommentar) — jeder Knopf öffnet das passende Feld oder springt zur Liste. Rechts, wie in Trello, stehen die **Kommentare** als eigene Spalte neben den Karten. **Projektseite öffnen** führt zur ganzen Seite; geschlossen wird mit dem **Kreuz** ganz rechts in der Leiste oder mit Escape — ein Klick neben die Karte schließt sie absichtlich nicht, damit nichts Getipptes verloren geht. Die Adresse mit `?card=…` lässt sich als Link weitergeben. **Zusammenführen** (ein doppelt angelegtes Projekt in dieses übernehmen, nur Administrator) steht neben Speichern und Abbrechen, sobald **Bearbeiten** gedrückt ist. Der Knopf **Filter** neben der Suche engt Board und Liste ein: ein Mitarbeiter (als Bauleitung oder im Team), ein Gewerk, nur dringende — im Feld oben tippen, die Listen suchen mit, Enter nimmt den ersten Treffer; die Wahl bleibt beim Wechsel zwischen den Boards erhalten.
