...
Boards anlegen, umbenennen, Spalten wählen und löschen: **Einstellungen → Boards** (Administrator). Jede Spalte ist ein Status und kann auf dem Board einen **eigenen Namen** tragen. Das letzte Board lässt sich nicht löschen.
