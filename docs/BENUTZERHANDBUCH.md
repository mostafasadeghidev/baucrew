...
**Archivieren** — wie in Trello: **Archivieren** in der Leiste des Projekts legt die Karte weg: Sie verschwindet vom Board, aus der Liste, von der Seite Baustellen und aus der Pipeline, bleibt aber ein Projekt — in der Einsatzplanung, im CRM, auf ihrer eigenen Seite, die es oben in einem gelben Balken sagt. Nichts wird gelöscht. **Archivierte Karten** im Board-Menü öffnet den Archivbereich rechts über dem Board; **Wiederherstellen** holt eine Karte zurück auf das Board. Ein **Titelbild** bekommt eine Karte in der Dateikarte des Projekts: unter jedem Foto steht *Titelbild*; ein zweiter Klick nimmt es wieder weg.
